...
{
    /// <summary>
    /// Валидатор класса <see cref="CreateFuelAccountingItemRequest"/>
    /// </summary>
    public class CreateFuelAccountingItemRequestValidator : AbstractValidator<CreateFuelAccountingItemRequest>
    {
        /// <summary>
        /// Инициализирует <see cref="CreateFuelAccountingItemRequestValidator"/>
        /// </summary>
        public CreateFuelAccountingItemRequestValidator(IDriverReadRepository driverReadRepository,
